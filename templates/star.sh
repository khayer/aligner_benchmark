...
ruby <%= @aligner_benchmark %>/compare2truth_multi_mappers.rb <%= @cut_bases %> <%= @cig_file %> fixed.sam > comp_res_multi_mappers.txt
ruby <%= @aligner_benchmark %>/compare2truth.rb <%= @cut_bases %> <%= @cig_file %> fixed.sam > comp_res.txt
