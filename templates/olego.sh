#!/bin/bash -e
#BSUB -J olego_stats<%= @run_name %>              # LSF job name
#BSUB -o olego_stats<%= @run_name %>.%J.out       # Name of the job output file
#BSUB -e olego_stats<%= @run_name %>.%J.error     # Name of the job error file
