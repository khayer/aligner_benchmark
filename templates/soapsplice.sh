#!/bin/bash -e
#BSUB -J soapsplice_stats<%= @run_name %>              # LSF job name
#BSUB -o soapsplice_stats<%= @run_name %>.%J.out       # Name of the job output file
#BSUB -e soapsplice_stats<%= @run_name %>.%J.error     # Name of the job error file
