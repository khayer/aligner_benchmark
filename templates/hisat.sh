#!/bin/bash -e
#BSUB -J hisat_stats              # LSF job name
#BSUB -o hisat_stats.%J.out       # Name of the job output file
#BSUB -e hisat_stats.%J.error     # Name of the job error file
#BSUB -M 18432

cd <%= @stats_path %>

ln -s <%= @tool_result_path %>/output.sam fixed.sam
