#!/bin/bash -e
#BSUB -J hisat_stats<%= @run_name %>              # LSF job name
#BSUB -o hisat_stats<%= @run_name %>.%J.out       # Name of the job output file
#BSUB -e hisat_stats<%= @run_name %>.%J.error     # Name of the job error file
