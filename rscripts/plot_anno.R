...
d = read.csv("../test_file_anno_malaria", head =T,sep = "\t", colClasses = cols)
...
l  = spread(d[,c("level","algorithm","annotation",
                 "color","measurement","value")], measurement, value)

l$"aligned correctly" = 1-l$"aligned ambiguously"-l$unaligned-l$"aligned incorrectly"

l$"aligned correctly"[l$"aligned correctly" == 1] = 0

gat = gather(l,measurement,value,-level, -algorithm, -color, -annotation)
...
plot_100_plot(r,"percent of total bases","human base level","anno/human_t3_BASE.pdf")

r = gat[ gat$level == "BASE",]
plot_100_plot(r,"percent of total bases","malaria base level","anno/malaria_t3_BASE.pdf")
